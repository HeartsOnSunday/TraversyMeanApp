...
// @route Post api/profile/education --HEADERINFO
// @desc Add education to Profile --HEADERINFO
// @access Private(requires user submitting form)  --HEADERINFO
router.post(
  "/education",
  passport.authenticate("jwt", { session: false }),
...
// @route DELETE api/profile/experience/:exp_id --HEADERINFO
// @desc Delete experience from Profile --HEADERINFO
// @access Private(requires user submitting form)  --HEADERINFO
router.delete(
  "/experience/:exp_id",
  passport.authenticate("jwt", { session: false }),
...
// @route DELETE api/profile/education/:edu_id --HEADERINFO
// @desc Delete education from Profile --HEADERINFO
// @access Private(requires user submitting form)  --HEADERINFO
router.delete(
  "/education/:edu_id",
  passport.authenticate("jwt", { session: false }),
...
// @route DELETE api/profile --HEADERINFO
// @desc Delete User and Profile --HEADERINFO
// @access Private(requires user submitting form)  --HEADERINFO
router.delete(
  "/",
  passport.authenticate("jwt", { session: false }),
